...
gwent could always use more documentation, whether as part of the
official gwent docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 3.5+, and for PyPy. Check github actions
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_gwent
