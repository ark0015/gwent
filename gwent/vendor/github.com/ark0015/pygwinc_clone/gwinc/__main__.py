...
""".format(
    ", ".join(["'{}'".format(ifo) for ifo in available_ifos()])
)
...
group.add_argument(
    "--yaml", "-y", action="store_true", help="print IFO as yaml to stdout and exit"
)
group.add_argument(
    "--text",
    "-x",
...
group.add_argument(
    "--no-plot", "-np", action="store_false", dest="plot", help="supress plotting"
)
parser.add_argument(
    "IFO",
