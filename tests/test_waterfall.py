...
def test_LISA_prop1(source_space_based):
    ...
    Background = False
    T_type = 'N'
    LISA_prop1 = detector.SpaceBased('LISA_ESA',T_obs,L,A_acc,
        f_acc_break_low,f_acc_break_high,A_IMS,f_IMS_break,
        Background=Background,T_type=T_type)
    [lisa_sample_x,lisa_sample_y,lisa_SNR] = snr.Get_SNR_Matrix(source_space_based,LISA_prop1,var_x,sampleRate_x,
        var_y,sampleRate_y)
...
def test_ET(source_ground_based):
    ...
    [et_sample_x,et_sample_y,et_SNR] = snr.Get_SNR_Matrix(source_ground_based,ET,var_x,sampleRate_x,var_y,sampleRate_y)
...
def test_aLIGO(source_ground_based):
    ...
    [aLIGO_sample_x,aLIGO_sample_y,aLIGO_SNR] = snr.Get_SNR_Matrix(source_ground_based,aLIGO,var_x,sampleRate_x,var_y,sampleRate_y)
